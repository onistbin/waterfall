...
window.onload = function(){
	var url = 'http://api.xiaohua.360.cn/Baoxiao/listData?callback=__callback&tag=&page=1'; //数据请求的url
	new WaterfallUnit({
...
var WaterfallUnit = (function ( $, window, document, undefined ){
	/*
		配置模板，调用数据
	*/
	var layoutTpl  = [
